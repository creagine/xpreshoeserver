...
import com.creaginetech.xpreshoesshipper.ViewHolder.OrderViewHolder;
...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadAllOrderNeedShip(Common.currentShipper.getPhoneShipper());
    }

    private void loadAllOrderNeedShip(String phoneShipper) {

        DatabaseReference orderInChildOfShipper = shipperOrders.child(phoneShipper);
    ...
    private void updateTokenShipper(String token) {
        ...
        tokens.child(Common.currentShipper.getPhoneShipper()).setValue(data);
    }
