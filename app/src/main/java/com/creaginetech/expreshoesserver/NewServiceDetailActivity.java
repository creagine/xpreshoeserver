...
public class NewServiceDetailActivity extends AppCompatActivity implements View.OnClickListener {
...
//                collapsingToolbarLayout.setTitle(currentService.getServiceName());
    ...
    private void selectImage() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (ContextCompat.checkSelfPermission(NewServiceDetailActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED){
                Toast.makeText(NewServiceDetailActivity.this, "Permission denied !", Toast.LENGTH_SHORT).show();
                ActivityCompat.requestPermissions(NewServiceDetailActivity.this,new String[]{Manifest.permission.READ_EXTERNAL_STORAGE},1);
            } else {
    ...
    private void bringImagePicture() {
        ...
        CropImage.activity()
                ...
                .setAspectRatio(1,1)
                .start(NewServiceDetailActivity.this);
    }
    //[END to Crop image ]
    ...
    private void deleteItem() {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(NewServiceDetailActivity.this);
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                imageFolder.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(NewServiceDetailActivity.this, "Item Deleted !", Toast.LENGTH_SHORT).show();
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(NewServiceDetailActivity.this, "Failed to delete item", Toast.LENGTH_SHORT).show();
                    }
                });
                //END delete item
    ...
    private void updateItem() {
        ...
        if (saveUri != null && isChanged) {
            ...
            final ProgressDialog mDialog = new ProgressDialog(NewServiceDetailActivity.this);
            mDialog.show();
...
//            final StorageReference imageFolder = storage.getReferenceFromUrl(currentService.getServiceImage());
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(NewServiceDetailActivity.this, "Uploaded !!!", Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            mDialog.dismiss();
                            Toast.makeText(NewServiceDetailActivity.this, "" + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
    ...
    private void pushToDatabase(){
        ...
        if (TextUtils.isEmpty(serviceName) ){
            Toast.makeText(NewServiceDetailActivity.this, "Service Name is Empty !", Toast.LENGTH_SHORT).show();
            return;
        } else if (TextUtils.isEmpty(servicePrice)){
            Toast.makeText(NewServiceDetailActivity.this, "Service Price is Empty !", Toast.LENGTH_SHORT).show();
            return;
        } else if (TextUtils.isEmpty(serviceDesc)){
            Toast.makeText(NewServiceDetailActivity.this, "Service Description is Empty !", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        if (!imgUri.equals(Common.currentImage)){
            ...
            imageFolder.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(NewServiceDetailActivity.this, "Failed to update item", Toast.LENGTH_SHORT).show();
                }
            });
        }
        ...
        service.child(serviceId).updateChildren(update_item).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful())
                    Toast.makeText(NewServiceDetailActivity.this, "Item was updated !", Toast.LENGTH_SHORT).show();
                Intent homeIntent = new Intent(NewServiceDetailActivity.this,HomeNewActivity.class);
                startActivity(homeIntent);
                finish();
            }
