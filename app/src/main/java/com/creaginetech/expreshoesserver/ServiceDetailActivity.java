...
//                collapsingToolbarLayout.setTitle(currentService.getServiceName());
    ...
    //[START TO OPEN STORAGE TO SELECT IMAGE] - 1
    ...
    //[END TO OPEN STORAGE TO SELECT IMAGE] - 1
...
//            final StorageReference imageFolder = storage.getReferenceFromUrl(currentService.getServiceImage());
    ...
    //[START TO OPEN STORAGE TO SELECT IMAGE] - 2 (GET IMAGE FROM STORAGE)
    @Override
    ...
    //[END TO OPEN STORAGE TO SELECT IMAGE] - 2 (GET IMAGE FROM STORAGE)
